...
mov(SF, SD, SE, RD, RE):- longe(SF), perto(SD), longe(SE), seguirLento(RD,RE).
...
mov(SF, SD, SE, RD, RE):- perto(SF), longe(SD), longe(SE), vpe(RD,RE).
mov(SF, SD, SE, RD, RE):- perto(SF), longe(SD), perto(SE), vpd(RD,RE).
mov(SF, SD, SE, RD, RE):- perto(SF), longe(SD), mp(SE), vpd(RD,RE).
mov(SF, SD, SE, RD, RE):- perto(SF), perto(SD), longe(SE), vpe(RD,RE).
mov(SF, SD, SE, RD, RE):- perto(SF), perto(SD), perto(SE), vpe(RD,RE).
mov(SF, SD, SE, RD, RE):- perto(SF), perto(SD), mp(SE), vpd(RD,RE).
mov(SF, SD, SE, RD, RE):- perto(SF), mp(SD), longe(SE), vpe(RD,RE).
mov(SF, SD, SE, RD, RE):- perto(SF), mp(SD), perto(SE), vpe(RD,RE).
mov(SF, SD, SE, RD, RE):- perto(SF), mp(SD), mp(SE), girar(RD,RE).

mov(SF, SD, SE, RD, RE):- mp(SF), longe(SD), longe(SE), ve(RD,RE).
